    ...
    <div class="py-12">
        <div class="w-full px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-3 gap-4" style="display: grid; grid-template-columns: repeat(3, 1fr);">
                ...
                <!-- Tile 2 -->
                <a href="{{ route('admin.users.index', ['role' => 'Magazijnmedewerker']) }}" class="aspect-square bg-gradient-to-br from-green-500 to-emerald-700 rounded-xl p-6 shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-200 flex flex-col items-center justify-center text-white">
                    <svg class="h-20 w-20 mb-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m4 6h.01M5 20h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                    </svg>
                    <h3 class="text-lg font-bold text-center">Workers</h3>
                    <p class="text-sm text-center opacity-90 mt-1">{{ \App\Models\User::where('role', 'Magazijnmedewerker')->count() }}</p>
                </a>

                <!-- Tile 3 -->
                <a href="{{ route('voorraad.producten.index') }}" class="aspect-square bg-gradient-to-br from-purple-600 to-indigo-700 rounded-xl p-6 shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-200 flex flex-col items-center justify-center text-white">
                    <svg class="h-20 w-20 mb-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
